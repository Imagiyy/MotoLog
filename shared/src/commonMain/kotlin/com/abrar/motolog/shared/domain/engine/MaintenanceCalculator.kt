        ...
        return when (status) {
            MaintenanceStatus.OVERDUE -> {
                ...
                if (remainingKm != null && remainingKm <= 0.0) {
                    parts.add("${PlatformFormatter.formatThousands(abs(remainingKm))} km overdue")
                }
            ...
            MaintenanceStatus.DUE_SOON -> {
                ...
                if (remainingKm != null && remainingKm <= TrackingConstants.DUE_SOON_KM_THRESHOLD) {
                    parts.add("${PlatformFormatter.formatThousands(remainingKm)} km remaining")
                }
            ...
            MaintenanceStatus.OK -> {
                val parts = mutableListOf<String>()
                if (remainingKm != null) {
                    parts.add("${PlatformFormatter.formatThousands(remainingKm)} km left")
                }
