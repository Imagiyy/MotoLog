...
class ElevationCalculatorTest {
    ...
    @Test
    fun `empty and single point inputs produce zero gain and loss`() {
    ...
    @Test
    fun `flat elevation with noise below threshold produces zero gain and loss`() {
    ...
    @Test
    fun `steady climb produces accurate cumulative gain and zero loss`() {
    ...
    @Test
    fun `steady descent produces accurate cumulative loss and zero gain`() {
    ...
    @Test
    fun `climb and descent produces both gain and loss`() {
        // 50 -> 100 -> 50
    ...
    @Test
    fun `smoothing moving average reduces noise spikes`() {
